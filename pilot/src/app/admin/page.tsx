...
import { PasswordForm } from "../dashboard/[section]/password-form";
...
export default async function AdminPage({ searchParams }: { searchParams: Promise<{ invited?: string; error?: string }> }) {
  ...
  <section id="account" className="settings-grid spaced"><article><h2>Platform admin password</h2><p>Create or change the password for your platform-administrator account. You will remain signed in after saving it.</p><PasswordForm /></article><article><h2>Account security</h2><p>This password applies only to your platform-admin login. Invited landlords manage their own passwords separately.</p><dl><div><dt>Role</dt><dd>Platform administrator</dd></div><div><dt>Authentication</dt><dd>Supabase Auth</dd></div><div><dt>Session protection</dt><dd>Enabled</dd></div></dl></article></section></>;
}
